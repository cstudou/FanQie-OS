...
#define IDT_DESCRIPTOR_ATTRITUBE_DPL0 \
    ((IDT_DESCRIPTOR_P << 7） + (IDT_DESCRIPTOR_DPL0 << 5) + IDT_DESCRIPTOR_32_TYPE)
#define IDT_DESCRIPTOR_ATTRITUBE_DPL3 \
    ((IDT_DESCRIPTOR_P << 7） + (IDT_DESCRIPTOR_DPL3 << 5) + IDT_DESCRIPTOR_32_TYPE)
