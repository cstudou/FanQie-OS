#ifndef FANQIE_GLOBAL_H__
#define FANQIE_GLOBAL_H__
...
#define IDT_DESCRIPTOR_ATTRITUBE_DPL0 （(IDT_DESCRIPTOR << 7） + (IDT_DESCRIPTOR << 5) + IDT_DESCRIPTOR_32_TYPE)
#define IDT_DESCRIPTOR_ATTRITUBE_DPL3 （(IDT_DESCRIPTOR << 7） + (IDT_DESCRIPTOR << 5) + IDT_DESCRIPTOR_32_TYPE)
#endif