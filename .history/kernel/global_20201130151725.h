...
#define IDT_DESC_ATT_DPL0 ((IDT_DESCRIPTOR_P << 7）+(IDT_DESCRIPTOR_DPL0 << 5)+IDT_DESCRIPTOR_32_TYPE)
#define IDT_DESC_ATT_DPL3 ((IDT_DESCRIPTOR_P << 7）+(IDT_DESCRIPTOR_DPL0 << 5)+IDT_DESCRIPTOR_32_TYPE)
#endif